...
{
    vector<int>     number;  
                  // initialization without the number of elements

    vector<int>     number2(10); 
                  // initialization with the number of elements
    vector<int>     number3(10, -1); 
                  // initialization with the number of elements and the initial value -1
    ...
    // Insert elements by using the member function "puch_back"
    number.push_back(10);
    number.push_back(20);
    number.push_back(50);
    number.push_back(40);

    // print all elements in vector number by using Range-based for loop
    for(int val:number)
        cout<< setw(5) << val;
    cout << endl;
